...
if __name__ == "__main__":
    ...
    #test_word("abcabcabcabcabc", num_hidden=2, num_steps=5000)
    #test_class_names(interactive = True, interactive_top5 = False, num_hidden = 150, num_steps = 20000)
    #test_metal()
    #test_food(interactive_top5=True)
    test_company_names(interactive_top5=True)
    pass
